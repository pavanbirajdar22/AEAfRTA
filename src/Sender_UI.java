...
public class Sender_UI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Sender_UI window = new Sender_UI();
		...
		btnConnect.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					// textArea.append("Step 1: Public key received from
					// receiver\n");
					...
					// textArea.append("Step 2: Encrypted key sent to the
					// receiver\n");
					...
					// textArea.append("Step 3: Encrypted Shifting keys sent to
					// the receiver\n");
