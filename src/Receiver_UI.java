...
public class Receiver_UI extends JFrame {
	/**
	 * 
	 */
	...
	public void runReceiver() {
		try {
			...
			// txtadisplay.setText(txtadisplay.getText() + "Step 1: Public Key
			// sent\n");
			...
			// txtadisplay.setText(txtadisplay.getText() + "Step 2: Key
			// received\n");
			...
			// txtadisplay.setText(txtadisplay.getText() + "Step 3: ShiftingKeys
			// received\n");
			...
			// txtadisplay.setText(txtadisplay.getText() + "Step 4: Table
			// received\n\n");
	...
	public static void main(String args[]) {
		Receiver_UI ser = new Receiver_UI();
